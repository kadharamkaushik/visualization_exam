...
def getData(self):
    for company in piece:
	    ...
	    option.add_experimental_option("prefs",{"download.default_directory":r"D:\Msit\DADV\visualization_exam\daily_data"})
	    
	    browser = webdriver.Chrome(r"D:\Msit\DADV\visualization_exam\chromedriver.exe",chrome_options=option)
	    browser.get("https://finance.yahoo.com/quote/"+company+"/history?period1=1431887400&period2=1558117800&interval=1d&filter=history&frequency=1d")
